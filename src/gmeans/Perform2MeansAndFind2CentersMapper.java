 ...
 * @author tibo
 */
public class Perform2MeansAndFind2CentersMapper implements Mapper<LongWritable, Text, LongWritable, Point> {
    ...
    public void map(
        ...
        output.collect(new LongWritable(OFFSET + shortest), point);
    ...
    public void configure(JobConf job) {
        ...
        try {
            ...
            Logger.getLogger(Perform2MeansAndFind2CentersMapper.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void readCentersFromCache() throws IOException {
        ...
        for (int i = 0; i < number_centers; i++) {
            ...
            Logger.getLogger(Perform2MeansAndFind2CentersMapper.class.getName()).log(Level.INFO, key + " : " + value);
            if (value != null && value != "") {
